...
public class Wheat {
	...
	private void recipeExStackWheat(){
		...
		ItemStack wheat = itemManager.stackWheat;
	...
	private void recipeStackHay(){
		...
		ItemStack wheat = itemManager.exStackWheat;
	...
	private void recipeExStackHay(){
		...
		ItemStack hay = itemManager.stackHay;
	...
	private void recipeSandwich(){
		...
		ItemStack bread = itemManager.betterBread;
	...
	private void recipeNaturalSandwich(){
		...
		ItemStack sandwich = itemManager.sandwich;
		ItemStack bread = itemManager.betterBread;
		ItemStack seed = itemManager.crystalSeed;
		ItemStack beef = itemManager.stackCookedBeef;
	...
	private void recipeNaturalSandwichT2(){
		...
		ItemStack sandwich = itemManager.naturalSandwich;
		ItemStack bread = itemManager.betterBread;
		ItemStack wheat = itemManager.transWheat;
		ItemStack beef = itemManager.stackCookedBeef;
